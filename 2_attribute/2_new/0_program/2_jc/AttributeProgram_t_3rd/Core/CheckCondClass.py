...
class CheckCondition:
    # 클래스 생성시 인자로 받은 defaultAddConditionList 를 ConditionList 에 등록시키는 init 부분
    ...
    # 등록된 모든 Condition의 ConditionFunction 을 실행하여, 일괄적으로 Condition Check 하는 함수
    ...
    # checkCondAllParam 에서 넘겨준 개별적인 인자를 값으로 하여 실제로 ConditionCheck 를 시행하는 함수.
