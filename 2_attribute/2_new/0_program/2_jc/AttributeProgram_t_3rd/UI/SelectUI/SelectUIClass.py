...
class SelectUI(QMainWindow):
    ...
    # True/False Define 값들을 CheckBox 항목에 추가하는 함수
    ...
    # 주소값 Define 값들을 Label/LineEdit/PushButton 포맷으로 추가하는 함수
