...
# CORE_SHOW_LOG 값이 True 일 때, Log 출력 함수
...
# CORE_SHOW_LOG 값이 True 일 때, NoticeLog 출력 함수
...
# CORE_SHOW_LOG 값이 True 일 때, ErrorLog 출력 함수
...
# CORE_SHOW_LOG 값이 True 일 때, SuccessLog 출력 함수
...
# CORE_SHOW_LOG 값이 True 일 때, ModeLog 출력 함수
...
# 문자열 형태의 Bool 값을 0/1 int 값으로 리턴하는 함수
def isTrue(Bool):
...
# errorLogList 에 저장된 에러 로그들 출력하는 함수
def showErrorList():
