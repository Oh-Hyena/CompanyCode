...
################arg_pase로 바꿀 내용###########################
MAIN_DIR = r'/home/keti/attribute_data/0622_attribute_common_PA100K_market1501_39class_hat,bag,teenager'
# MAIN_DIR = r'/data/attribute_data/0916_attribute_common_PA100K_market1501_39class'
Config_File = r'/config.data'
Classes_File = r'/39class.name'
...
valset = valset.shuffle(buffer_size=5000)
