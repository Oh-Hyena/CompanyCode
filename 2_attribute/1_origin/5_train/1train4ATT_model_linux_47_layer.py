...
################arg_pase로 바꿀 내용###########################
MAIN_DIR = r'/data/attribute_data/0810_attribute_120K_lowercolor_lower_9class_47_earlystopping50'
...
TRAIN_IMG_DIR = r'/train_lower_img_list.txt'
TRAIN_MERGE_ATT = r'/train_lowercolor_annotation.txt'
VAL_IMG_DIR = r'/val_lower_img_list.txt'
VAL_MERGE_ATT = r'/val_lowercolor_annotation.txt'
