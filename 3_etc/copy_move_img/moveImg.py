"""
1. 이동할 이미지, 이동할 ImgList.txt, Annotation.txt, 이동할 save 폴더 경로 지정하기
2. save 폴더에는 이동한 이미지, save 폴더 경로로 수정된 ImgList.txt, Annotation.txt 파일 이동
"""
...
for eachCopyImg in copyList:
    ...
    try:
        shutil.move(eachCopyImg[COPY_PATH], savePath)
