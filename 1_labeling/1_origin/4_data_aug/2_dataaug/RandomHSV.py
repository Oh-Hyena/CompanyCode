...
xmlRootpath = r"D:\HN_code\test\1_labeling\11_RandomHSV\1_bus_img_xml\bus_xml"
#img_augmentation할_img
imageRootpath = r"D:\HN_code\test\1_labeling\11_RandomHSV\1_bus_img_xml\bus_img"
#저장할폴더(txt파일)
targetpath = r"D:\HN_code\test\1_labeling\11_RandomHSV\2_randomHSV_img_xml_txt\randomHSV_txt"
#이미지파일
targetpath1=r"D:\HN_code\test\1_labeling\11_RandomHSV\2_randomHSV_img_xml_txt\randomHSV_img"
save_xml=r"D:\HN_code\test\1_labeling\11_RandomHSV\2_randomHSV_img_xml_txt\randomHSV_xml"
########txt저장
# videoclass = "UnitrainNightdataset_bus_randomhsv"
# bicycle, bus, motorbike
videoclass = "bus_randomhsv"
mode = "jpg"
...
for k,img in enumerate(total_images):
    cv_img = imread(img)[:,:,::-1]
    b1=cv_img.copy()
    img_, bboxes_ = RandomHSV(50, 50, 50)(b1, a[k].copy())
    cv2.imwrite("temp2."+mode, img_[:,:,::-1])
    os.rename("temp2."+mode, os.path.join(videoclass +"_"+str(fileCount)+"."+mode))
