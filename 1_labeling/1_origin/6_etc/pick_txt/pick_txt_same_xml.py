...
xml_Rootpath=r"D:\HN_code\search\make_attribute_88_66_dataset\refine_attribute_dataset_practice\cvatxml"
#원본 imgRootpath (pure > JPEGImages > train 에 있는 image 사용) img_Rootpath=save_yolo
img_Rootpath=r"D:\HN_code\search\make_attribute_88_66_dataset\refine_attribute_dataset_practice\img"
copy_img_Rootpath=r"D:\HN_code\search\make_attribute_88_66_dataset\refine_attribute_dataset_practice\txt"
#os.mkdir(copy_img_Rootpath)

xmlname=os.listdir(xml_Rootpath)

# 변수 이름도 jpg->txt로 바꿔야 함
total_jpg_file_name=[]
total_jpg_file_path=[]
