...
dir_name = r"G:\labelingDataset\origin\test_dataset\coco17\data_process\xmls" #.xml파일의 위치를 전부 로드한다.(이미지 섞여있어도 됨.) (절대경로)
save_dir = r"G:\labelingDataset\origin\test_dataset\coco17\txt"              #yolo style txt 저장 위치. (절대경로)

category_dir = r"G:\labelingDataset\origin\test_dataset\coco17\basemodel.names" #카테고리 로드 (절대경로)
